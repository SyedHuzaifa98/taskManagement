<x-app-layout>
    ...
    <form class="addTask" id="addTask" action="{{ route('task.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="projectName" placeholder="Enter Project name or Learning" class="form-control"
                id="projectName">
        </div>
        <div class="mb-3">
